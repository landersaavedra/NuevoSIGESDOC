...
namespace SIGESDOC.Web.Controllers
{
    public class GeneralController : Controller
    {
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public ActionResult Llenar_direccion_externo(string externo)
        {
            var direccion_externo = _GeneralService.Recupera_direccion_externo(externo);

            return Json(direccion_externo, JsonRequestBehavior.AllowGet);
        }
