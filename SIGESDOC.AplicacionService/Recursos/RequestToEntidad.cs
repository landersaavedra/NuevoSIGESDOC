    ...
    public class RequestToEntidad
    {
        ...
        public static DAT_DOCUMENTO_DHCPA_DETALLE documento_dhcpa_detalle(DocumentoDhcpaDetalleRequest request)
        {
            DAT_DOCUMENTO_DHCPA_DETALLE item = new DAT_DOCUMENTO_DHCPA_DETALLE
            {
                ...
                OFICINA_SEDE = request.oficina_sede,
                OFICINA_EXTERNA = request.oficina_externa,
                DIRECCION_EXTERNO = request.direccion_externo
        };
        ...
        public static LOG_UID_ALFRESCO log_uid_alfresco(UidAlfrescoRequest request) 
        {
            LOG_UID_ALFRESCO item = new LOG_UID_ALFRESCO
            {
                ID_UID_ALFRESCO = request.id_uid_alfresco,
                NOM_DOC = request.nom_doc,
                TIPO_DOC = request.tipo_doc, 
                UID_ALFRESCO = request.uid_alfresco, 
                VERSION_DOCUMENTO = request.version_documento,
                FECHA_REGISTRO = request.fecha_registro, 
                ESTADO_DOC = request.estado_doc, 
                NUM_DOC = request.num_doc,
                PATHDOC_ALFRESCO = request.pathdoc_alfresco,
                PATHDOC_FTP = request.pathdoc_ftp,
                BPDF_DOC = request.bpdf_doc, 
                ID_DOCUMENTO = request.id_documento
            };
        ...
        public static MAE_FIRMA_DIGITAL  firma_digital(FirmaDigitalRequest request)
        {
            MAE_FIRMA_DIGITAL item = new MAE_FIRMA_DIGITAL
            {
                ID_FIRMA_DIGITAL = request.id_firma_digital,
                ID_DOCUMENTO = request.id_documento,
                PERSONA_FIRMAR = request.persona_firmar,
                ID_USUARIO_ENVIO = request.id_usuario_envio,
