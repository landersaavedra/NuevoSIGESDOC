...
namespace SIGESDOC.AplicacionService
{
    public class GeneralService : IGeneralService
    {
        ...
        private readonly IDireccionExternoRepositorio _DireccionExternoRepositorio;
        ...
        IProtocoloTransporteRepositorio ProtocoloTransporteRepositorio,
            ...
            IDireccionExternoRepositorio DireccionExternoRepositorio
        ...
        _ProtocoloTransporteRepositorio = ProtocoloTransporteRepositorio;
            ...
            _DireccionExternoRepositorio = DireccionExternoRepositorio;
        }
        ...
        public IEnumerable<DireccionExternoResponse> Recupera_direccion_externo(string externo)
        {
            var result = (from zp in _DireccionExternoRepositorio.Listar((x => x.RUC == externo))
                          select new DireccionExternoResponse
                          {
                               id_oficina_direccion = zp.ID_OFICINA_DIRECCION,
                               ruc = zp.RUC,   
                               direccion = zp.DIRECCION
                          }).OrderBy(r => r.direccion);
            return result.ToList();
        }
