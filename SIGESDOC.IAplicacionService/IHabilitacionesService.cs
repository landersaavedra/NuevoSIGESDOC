...
namespace SIGESDOC.IAplicacionService
{
    ...
    public interface IHabilitacionesService
    {
        ...
        [OperationContract]
        void InserirNuevoUIIDALfresco_FirmaDigital(string tipodocumento, string nom_doc, string num_doc, string uidAlfresco, string byteDoc);

        [OperationContract]
        void InserirNuevoUIIDALfresco_SinFirmaDigital(string tipodocumento, string nom_doc, string num_doc, string uidAlfresco, string byteDoc);
