...
namespace SIGESDOC.IAplicacionService
{
    ...
    public interface IHojaTramiteService
    {
        ...
        [OperationContract]
        IEnumerable<DetalleDocumentoExternoResponse> Listar_Detalle_Documento(int id_documento);

        [OperationContract]
        IEnumerable<DocumentoInternoExternoDhcpaResponse> Listar_Detalle_Documento_Interno_Externo(int id_documento);

        //Correctas
        [OperationContract]
        IEnumerable<MaeDocumentoDhcpaExternoResponse> Listar_Documento_DHCPA_Externo(int id_documento);

        [OperationContract]
        IEnumerable<MaeDocumentoDhcpaDetalleExternoResponse> Listar_Documento_DHCPA_Detalle_Externo(int id_documento);

        [OperationContract]
        IEnumerable<ColaboradoresRefirmaResponse> GetColaboradores(string nombres);

        [OperationContract]
        IEnumerable<DatDocumentodetalleDocinternosResponse> GetDocumentoDetalleInterno(int id_documento);
    }
}
